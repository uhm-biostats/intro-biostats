---
title: "BIOL 220 Problem Set 04: Probability"
subtitle: "Answer Key"
format:
  pdf:
    toc: false
...
![A mōlī seen from Kauaʻi, Photo credit: DickDaniels (http://carolinabirds.org/)](img/Laysan_Albatross_RWD2.jpg){width=75%}
...
4a. The events "survive" and "recruit" are not mutually exclusive. A bird can survive and recruit *or* not recruit. Recruitment is very much *dependent* on survival, and $Pr(\text{yes recruit} | \text{no survive}) = 0$, but that does not make them mututally exclusive

4b. The reported probabilities are $Pr(\text{recruit} \mid \text{survive})$. That is because the only way for the researchers to observe recruitment is if the bird survived in the first place. 
